...
namespace STLRom
{
    ...
    public:
        ...
        // Smooth approximation of robustness (see smooth_approx.h).
        // tau is the temperature; higher values converge to exact robustness.
        double eval_smooth_rob(double tau, SmoothType type = SmoothType::LSE);
        double eval_smooth_rob(double t_start, double t_end, double tau, SmoothType type = SmoothType::LSE);
